...
const eBankingServices = [
  {
    ...
    name: "BNIdirect",
    description:
      "Layanan internet banking untuk nasabah korporat dan komersial",
    icon: "laptop",
    color: "#FF6600",
        ...
        <View style={styles.featuresSection}>
          <View style={styles.featuresContainer}>
            {visibleFeatures.map((feature, index) => (
              ...
              >
                <Text style={[styles.featureText, { color: item.color }]}>
                  {feature}
                </Text>
              </View>
            ))}
            {item.features.length > 3 && (
              <TouchableOpacity
                style={[
                  styles.moreFeatures,
                  {
                    backgroundColor: isExpanded ? `${item.color}15` : "#f0f0f0",
                  },
                ]}
              ...
              >
                <Text
                  style={[
                    styles.moreText,
                    { color: isExpanded ? item.color : "#666" },
                  ]}
                >
    ...
    <View style={styles.headerContent}>
      <View style={styles.heroSection}>
        <Text style={styles.heroSubtitle}>
          Akses mudah layanan perbankan BNI kapan saja, dimana saja dengan
          teknologi terdepan dan keamanan terjamin
        </Text>
